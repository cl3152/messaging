...
@Service
public class ArbeitnehmerService_alt {
    ...
    public ArbeitnehmerService_alt(TransferRepository transferRepository, ArbeitnehmerRepository arbeitnehmerRepository, TransactionTemplate transactionTemplate) {
